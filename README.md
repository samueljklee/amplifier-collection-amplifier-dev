...
amplifier> "Explain the provider contract"
...
- **amplifier-dev** - Main profile for Amplifier development with access to all contracts and architecture docs
- **sam** - Evidence-driven development profile with systematic thinking patterns (Anthropic provider)
- **sam-openai** - Evidence-driven development profile with systematic thinking patterns (OpenAI provider)
