...
profile:
  name: amplifier-dev
  version: 1.0.0
  description: Profile for building Amplifier modules, profiles, and collections
...
If web fetch fails, refer to the embedded summaries in `@amplifier-dev:context/contracts/` which contain snapshots of the contracts (may be slightly out of date).
